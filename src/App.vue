...
<v-app>
    ...
    >
      ...
      <v-spacer></v-spacer>
      <v-toolbar-title>Tech-Assessment</v-toolbar-title>
      <v-spacer></v-spacer>
      <v-avatar tile>
        <img src="@/assets/mudbath_logo.jpg" id="mudbath_logo">
      </v-avatar>
    </v-app-bar>
    ...
    >
      ...
      >
        ...
        >
          <v-list-item exact>
            <v-list-item-icon>
              <v-icon color="#006064">mdi-home</v-icon>
            </v-list-item-icon>
          ...
          <v-list-item exact>
            <v-list-item-icon>
              <v-icon color="#006064">mdi-account</v-icon>
            </v-list-item-icon>
